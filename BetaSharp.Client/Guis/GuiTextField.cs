    ...
    public void drawTextBox()
    {
        ...
        if (isEnabled)
        {
            ...
            if (HasSelection())
            {
                ...
                fontRenderer.drawString(beforeSel, displayStartX, displayY, 0xE0E0E0);
                ...
                fontRenderer.drawString(afterSel, displayStartX + beforeWidth + selWidth, displayY, 0xE0E0E0);
            }
            else
            {
                ...
                fontRenderer.drawString(beforeCursor + cursor + afterCursor, displayStartX, displayY, 0xE0E0E0);
            }
        }
        else
        {
            drawString(fontRenderer, text, displayStartX, displayY, 0x707070);
        }
    }
