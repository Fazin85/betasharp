...
public class GuiErrorScreen : GuiScreen
{
    ...
    public override void Render(int mouseX, int mouseY, float tickDelta)
    {
        ...
        Gui.DrawString(FontRenderer, "Minecraft has run out of memory.", Width / 2 - 140, Height / 4 - 60 + 60 + 0, 0xA0A0A0);
        Gui.DrawString(FontRenderer, "This could be caused by a bug in the game or by the", Width / 2 - 140, Height / 4 - 60 + 60 + 18, 0xA0A0A0);
        Gui.DrawString(FontRenderer, "Java Virtual Machine not being allocated enough", Width / 2 - 140, Height / 4 - 60 + 60 + 27, 0xA0A0A0);
        Gui.DrawString(FontRenderer, "memory. If you are playing in a web browser, try", Width / 2 - 140, Height / 4 - 60 + 60 + 36, 0xA0A0A0);
