...
public class CactusRenderer : IBlockRenderer
{
    public bool Render(IBlockAccess world, Block block, in BlockPos pos, Tessellator tess, in BlockRenderContext context)
    {
        ...
        // Create a dummy FaceColors struct since Cactus uses flat shading, not AO
        ...
        if (context.RenderAllFaces || bounds.MinY > 0.0D || block.isSideVisible(world, pos.x, pos.y - 1, pos.z, 0))
        {
            ...
            Helper.RenderBottomFace(block, new Vec3D(pos.x, pos.y, pos.z), tess, context, dummyColors, tex, context.FlipTexture);
            hasRendered = true;
        }
        ...
        if (context.RenderAllFaces || bounds.MaxY < 1.0D || block.isSideVisible(world, pos.x, pos.y + 1, pos.z, 1))
        {
            ...
            Helper.RenderTopFace(block, new Vec3D(pos.x, pos.y, pos.z), tess, context, dummyColors, tex, context.FlipTexture);
            hasRendered = true;
        }
        ...
        if (context.RenderAllFaces || bounds.MinZ > 0.0D || block.isSideVisible(world, pos.x, pos.y, pos.z - 1, 2))
        {
            ...
            Helper.RenderEastFace(block, new Vec3D(pos.x, pos.y, pos.z), tess, context, dummyColors, tex, context.FlipTexture);
        ...
        if (context.RenderAllFaces || bounds.MaxZ < 1.0D || block.isSideVisible(world, pos.x, pos.y, pos.z + 1, 3))
        {
            ...
            Helper.RenderWestFace(block, new Vec3D(pos.x, pos.y, pos.z), tess, context, dummyColors, tex, context.FlipTexture);
        ...
        if (context.RenderAllFaces || bounds.MinX > 0.0D || block.isSideVisible(world, pos.x - 1, pos.y, pos.z, 4))
        {
            ...
            Helper.RenderNorthFace(block, new Vec3D(pos.x, pos.y, pos.z), tess, context, dummyColors, tex, context.FlipTexture);
        ...
        if (context.RenderAllFaces || bounds.MaxX < 1.0D || block.isSideVisible(world, pos.x + 1, pos.y, pos.z, 5))
        {
            ...
            Helper.RenderSouthFace(block, new Vec3D(pos.x, pos.y, pos.z), tess, context, dummyColors, tex, context.FlipTexture);
