...
public class TorchRenderer : IBlockRenderer
{
        ...
        in BlockRenderContext context)
    {
        ...
        {
            RenderTorchAtAngle(block, tess, new Vec3D(pos.x - horizontalOffset, pos.y + verticalOffset, pos.z),
        ...
        {
            RenderTorchAtAngle(block, tess, new Vec3D(pos.x, pos.y + verticalOffset, pos.z - horizontalOffset), 0.0D,
                -tiltAmount,context);
        }
        ...
        {
            RenderTorchAtAngle(block, tess, new Vec3D(pos.x, pos.y, pos.z), 0.0D, 0.0D,context);
        }

        return true;
    }

    private void RenderTorchAtAngle(in Block block, in Tessellator tess, in Vec3D pos, double tiltX, double tiltZ,
        in BlockRenderContext context)
    {
