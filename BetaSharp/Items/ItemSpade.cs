...
public class ItemSpade : ItemTool
{
    ...
    private static Block[] blocksEffectiveAgainst = new Block[] { Block.GRASS_BLOCK, Block.Dirt, Block.SAND, Block.Gravel, Block.Snow, Block.SnowBlock, Block.Clay, Block.Farmland };
