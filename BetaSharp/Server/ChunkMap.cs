        ...
        public void updateChunk()
        {
            ...
            if (_dirtyBlockCount != 0)
            {
                if (_dirtyBlockCount == 1)
                {
                    ...
                    if (Block.BlocksWithEntity[sWorld.getBlockId(worldX, worldY, worldZ)])
                    {
                        sendBlockEntityUpdate(sWorld.getBlockEntity(worldX, worldY, worldZ));
                    }
                }
                ...
                else
                {
                    ...
                    for (int i = 0; i < _dirtyBlockCount; i++)
                    {
                        ...
                        if (Block.BlocksWithEntity[sWorld.getBlockId(var13, var15, var16)])
                        {
                            sendBlockEntityUpdate(sWorld.getBlockEntity(var13, var15, var16));
                        }
                    }
                }
